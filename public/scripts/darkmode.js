...
function toggleDarkMode() {
	...
	//maan
		...
		document.getElementById("darkModeToggle").innerHTML = '<svg class="animate-[pulse_5s_cubic-bezier(0.4,_0,_0.6,_1)_infinite] h-6 w-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path></svg>';
